...
| Lang-uage | Oper-ation | Temp-lated | Time [s] | Slowdown vs [Best] | Exec Version | Exec Path |
| :---: | :---: | --- | :---: | :---: | :---: | :---: |
| D | Check | No | 0.620 | 1.0 [D] | v2.093.0-344-ga1cb3f44c | `~/.local/dlang/linux/bin64/dmd` |
| D | Check | No | 0.700 | 1.1 [D] | 1.23.0-beta1 | `~/.local/ldc2-1.23.0-beta1-linux-x86_64/bin/ldmd2` |
| D | Check | Yes | 1.470 | 2.4 [D] | v2.093.0-344-ga1cb3f44c | `~/.local/dlang/linux/bin64/dmd` |
| D | Check | Yes | 1.681 | 2.7 [D] | 1.23.0-beta1 | `~/.local/ldc2-1.23.0-beta1-linux-x86_64/bin/ldmd2` |
| D | Build | No | 1.444 | 1.0 [D] | v2.093.0-344-ga1cb3f44c | `~/.local/dlang/linux/bin64/dmd` |
| D | Build | No | 18.251 | 12.6 [D] | 1.23.0-beta1 | `~/.local/ldc2-1.23.0-beta1-linux-x86_64/bin/ldmd2` |
| D | Build | Yes | 2.593 | 1.8 [D] | v2.093.0-344-ga1cb3f44c | `~/.local/dlang/linux/bin64/dmd` |
| D | Build | Yes | 18.227 | 12.6 [D] | 1.23.0-beta1 | `~/.local/ldc2-1.23.0-beta1-linux-x86_64/bin/ldmd2` |
| C | Check | No | 0.696 | 1.1 [D] | 8.4.0 | `/usr/bin/gcc-8` |
| C | Check | No | 1.036 | 1.7 [D] | 9.3.0 | `/usr/bin/gcc-9` |
| C | Check | No | 1.087 | 1.8 [D] | 10 | `/usr/bin/gcc-10` |
| C | Check | No | 2.170 | 3.5 [D] | 8.0.1 | `/usr/bin/clang-8` |
| C | Check | No | 2.550 | 4.1 [D] | 9.0.1 | `/usr/bin/clang-9` |
| C | Check | No | 2.508 | 4.0 [D] | 10.0.0 | `/usr/bin/clang-10` |
| C | Build | No | 32.086 | 22.2 [D] | 8.4.0 | `/usr/bin/gcc-8` |
| C | Build | No | 35.975 | 24.9 [D] | 9.3.0 | `/usr/bin/gcc-9` |
| C | Build | No | 38.517 | 26.7 [D] | 10 | `/usr/bin/gcc-10` |
| C | Build | No | 14.913 | 10.3 [D] | 8.0.1 | `/usr/bin/clang-8` |
| C | Build | No | 15.661 | 10.8 [D] | 9.0.1 | `/usr/bin/clang-9` |
| C | Build | No | 16.414 | 11.4 [D] | 10.0.0 | `/usr/bin/clang-10` |
| C++ | Check | No | 1.762 | 2.8 [D] | 8.4.0 | `/usr/bin/g++-8` |
| C++ | Check | No | 3.131 | 5.0 [D] | 9.3.0 | `/usr/bin/g++-9` |
| C++ | Check | No | 3.145 | 5.1 [D] | 10 | `/usr/bin/g++-10` |
| C++ | Check | No | 3.120 | 5.0 [D] | 8.0.1 | `/usr/bin/clang++-8` |
| C++ | Check | No | 3.255 | 5.2 [D] | 9.0.1 | `/usr/bin/clang++-9` |
| C++ | Check | No | 3.380 | 5.4 [D] | 10.0.0 | `/usr/bin/clang++-10` |
| C++ | Check | Yes | 5.323 | 8.6 [D] | 8.4.0 | `/usr/bin/g++-8` |
| C++ | Check | Yes | 7.286 | 11.7 [D] | 9.3.0 | `/usr/bin/g++-9` |
| C++ | Check | Yes | 7.358 | 11.9 [D] | 10 | `/usr/bin/g++-10` |
| C++ | Check | Yes | 4.799 | 7.7 [D] | 8.0.1 | `/usr/bin/clang++-8` |
| C++ | Check | Yes | 5.097 | 8.2 [D] | 9.0.1 | `/usr/bin/clang++-9` |
| C++ | Check | Yes | 5.354 | 8.6 [D] | 10.0.0 | `/usr/bin/clang++-10` |
| C++ | Build | No | 34.819 | 24.1 [D] | 8.4.0 | `/usr/bin/g++-8` |
| C++ | Build | No | 39.132 | 27.1 [D] | 9.3.0 | `/usr/bin/g++-9` |
| C++ | Build | No | 40.489 | 28.0 [D] | 10 | `/usr/bin/g++-10` |
| C++ | Build | No | 15.827 | 11.0 [D] | 8.0.1 | `/usr/bin/clang++-8` |
| C++ | Build | No | 16.398 | 11.4 [D] | 9.0.1 | `/usr/bin/clang++-9` |
| C++ | Build | No | 16.878 | 11.7 [D] | 10.0.0 | `/usr/bin/clang++-10` |
| C++ | Build | Yes | 40.539 | 28.1 [D] | 8.4.0 | `/usr/bin/g++-8` |
| C++ | Build | Yes | 47.433 | 32.8 [D] | 9.3.0 | `/usr/bin/g++-9` |
| C++ | Build | Yes | 48.699 | 33.7 [D] | 10 | `/usr/bin/g++-10` |
| C++ | Build | Yes | 18.964 | 13.1 [D] | 8.0.1 | `/usr/bin/clang++-8` |
| C++ | Build | Yes | 19.046 | 13.2 [D] | 9.0.1 | `/usr/bin/clang++-9` |
| C++ | Build | Yes | 24.981 | 17.3 [D] | 10.0.0 | `/usr/bin/clang++-10` |
| Go | Check | No | 2.308 | 3.7 [D] | 10.0.1 | `/usr/bin/gccgo` |
| Go | Build | No | 58.561 | 40.5 [D] | 10.0.1 | `/usr/bin/gccgo` |
| V | Build | No | 16.350 | 11.3 [D] | 0.1.28 | `~/ware/vlang/v` |
| Zig | Check | No | 7.676 | 12.4 [D] | 0.6.0+cf4936bcb | `/snap/bin/zig` |
| Zig | Check | Yes | 10.146 | 16.4 [D] | 0.6.0+cf4936bcb | `/snap/bin/zig` |
| Rust | Check | No | 37.409 | 60.3 [D] | 1.45.2 | `~/.cargo/bin/rustc` |
| Rust | Check | No | 23.378 | 37.7 [D] | 1.47.0-nightly | `~/.cargo/bin/rustc` |
| Rust | Check | Yes | 35.557 | 57.3 [D] | 1.45.2 | `~/.cargo/bin/rustc` |
| Rust | Check | Yes | 24.342 | 39.2 [D] | 1.47.0-nightly | `~/.cargo/bin/rustc` |
| Rust | Build | No | 70.577 | 48.9 [D] | 1.45.2 | `~/.cargo/bin/rustc` |
| Rust | Build | No | 70.312 | 48.7 [D] | 1.47.0-nightly | `~/.cargo/bin/rustc` |
| Rust | Build | Yes | 45.144 | 31.3 [D] | 1.45.2 | `~/.cargo/bin/rustc` |
| Rust | Build | Yes | 46.504 | 32.2 [D] | 1.47.0-nightly | `~/.cargo/bin/rustc` |
| Java | Build | No | 8.782 | 6.1 [D] | 1.8.0_171 | `/usr/bin/javac` |
| OCaml | Build | No | 8.441 | 5.8 [D] | 4.08.1 | `/usr/bin/ocamlc` |
